...
from smolagents import CodeAgent, GoogleSearchTool, VisitWebpageTool, LiteLLMModel
...
def check_reasoning_and_plot(final_answer, agent_memory):
    ...
    multimodal_model = model_llama32_vision
...
web_agent = CodeAgent(
    ...
    name="web_agent",
    description="searches the web to find information",
    verbosity_level=0,
    max_steps=10,
)
